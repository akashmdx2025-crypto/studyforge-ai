...
export const CHAT_SYSTEM_PROMPT = `You are StudyForge AI, a study assistant. You MUST follow these rules strictly:
...
export const QUIZ_SYSTEM_PROMPT = `Generate exactly {n} multiple choice quiz questions based ONLY on the following study material.
...
export const FLASHCARD_SYSTEM_PROMPT = `Create exactly {n} flashcards from the following study material.
...
export const SUMMARY_SYSTEM_PROMPT = `Create a {detail_level} summary of the following study material.
